...
export function ProtocolArchitecture() {
  ...
  return (
    <section id="milestones" className="py-24 border-t border-[#EAE3D2] bg-white relative overflow-hidden">
      {/* Background Half-Shapes for Protocol Architecture */}
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden select-none -z-10">
        {/* Semicircle on top-right edge */}
        <div className="absolute -top-24 right-10 w-96 h-48 opacity-30">
        ...
        <div className="absolute -bottom-20 -left-16 w-80 h-80 opacity-30">
          <svg viewBox="0 0 240 240" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
            <path
              d="M 20,220 A 180,180 0 0,1 220,220"
              stroke="#C59B5F"
              strokeWidth="1.5"
              strokeOpacity="0.4"
            />
            <path
              d="M 60,220 A 140,140 0 0,1 200,220"
              stroke="#D4AF37"
              strokeWidth="1"
              strokeDasharray="4 6"
              strokeOpacity="0.3"
